...
import { runHauntedHouseLoop, runSportsCommentaryLoop, runRealityTVLoop, runAuctionHouseLoop, runEscapeRoomLoop } from './modes/ExpandedRealityModes';
import { runMuseumLoop } from './modes/MuseumMode';
import { runJobInterviewLoop } from './modes/InterviewMode';
import { runCookingShowLoop } from './modes/CookingMode';
...
export interface Scenario {
    type: 'improv' | 'script' | 'reaction' | 'narrative' | 'reporter' | 'roast' | 'story' | 'debate' | 'musical' | 'podcast' |'interview' | 'dungeon_master' | 'autonomous' | 'trivia' | 'dream' | 'vision' | 'trial' | 'tech_support' | 'historical' | 'commentary' | 'mystery' | 'pitch' | 'code_review' | 'therapy' | 'philosopher' | 'alien' | 'time_travel' | 'chef' | 'medical' | 'haunted' | 'sports' | 'reality_tv' | 'auction_house' | 'escape_room' | 'interrogation' | 'museum' | 'job_interview' | 'cooking_show';
    title: string;
    description: string;
    config?: {
        chaosLevel?: number;
