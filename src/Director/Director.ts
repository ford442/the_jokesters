...
import { runSentientVendingMachineRestockerLoop, runPassiveAggressiveSmartHomeLoop, runSentientShoppingCartLoop } from './modes/DreamModes_Sentient';
...
export interface Scenario {
    ...
    | 'internet_explorer_support_group'
